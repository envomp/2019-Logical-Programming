...
`def _draw_card(self) -> Card:` Kuna iga kord, kui jagatakse kellegile kaart (välja arvatud tagurpidi olev kaart diileril)
tuleb kutsuda iga mängija strateegial välja vastav funktsioon, siis on mõistlik see pakkida abifunktsiooni.
