...
korrektsust. Mallis on kaasas ka palju näiteid, millised on õiged ja valed väljundid 
funktsioonidel. Alguses ei lähe sul kindlasti neid kõiki vaja, seega kommenteeri välja need
funktsioonid, mis pole sul veel lahendatud.
...
def get_full_year(gender_number: int, year: int) -> int:
    """
